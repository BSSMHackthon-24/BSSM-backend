...
public class MqttConfig {
    private static final String PUB_CLIENT_ID = "mqtt-anys-pub";

//    @Autowired
//    private MqttListener mqttListener;

    private final String brokerUrl = "tcp://broker.mqtt-dashboard.com";
    private final String topic = "bssm";
    ...
    public MessageHandler mqttOutbound() {
        MqttPahoMessageHandler handler = new MqttPahoMessageHandler(PUB_CLIENT_ID, mqttPahoClientFactory());
